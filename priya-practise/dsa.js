...
//     Matchnum(N,arr1,M,arr2)
    
//    }
//  }
// function Matchnum(N,arr1,M,arr2){
//     var left=0;
//     var right=0;
//     var box="";
//     count=0;
...
//             right++
//         }
//         else if(arr1[left]>arr2[right]) //2>3
//         {
//             right++
//         }
//         else{
...
//  const ppp = new Promise((resolve, rejected) => {
//   setTimeout(() => {
...
//   console.log("promise rejected");
//  })
//  ppp.then((value) => console.log(value))
...
// let arr = [3,4,1,8,2,0,3,0,2,5,3,8,4]
// let n = arr.length;
// for(let p=0; p<n; p++){
//   for(let q=0; q<n; q++){
//     if(arr[q]> arr[q+1]){
...
// let array = arr.sort((a,b) => a-b).reverse()[1]
// console.log(array)
